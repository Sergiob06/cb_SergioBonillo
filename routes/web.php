...
Route::get('clasificacion', [BasketController::class, 'clasificacion'])->name('basket.clasificacion');
...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::get('/', function () {
        return view('admin.dashboard', [
            'resumenAdmin' => [
                ...
                'clasificaciones' => Clasificacion::count(),
    ...
    Route::get('clasificaciones/search', [ClasificacionController::class, 'search'])->name('clasificaciones.search');
