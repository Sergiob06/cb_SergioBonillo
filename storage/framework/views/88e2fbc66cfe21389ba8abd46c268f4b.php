...
<div class="contenedor-edit-jugador">
    <header class="header-ficha">
        ...
        <a href="<?php echo e(route('galerias.index')); ?>" class="btn-nuevo" style="background-color: #777;">
    ...
    <div class="pizarra-ficha">
        <form action="<?php echo e(route('galerias.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo $__env->make('admin.galerias.partials.form', ['galeria' => null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sergio/proyecto2DAW_SergioBonillo_PauVila/BellreguardBasket/resources/views/admin/galerias/create.blade.php ENDPATH**/ ?>