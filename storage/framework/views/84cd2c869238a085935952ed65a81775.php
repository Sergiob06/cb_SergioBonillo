...
<div class="contenedor-edit-jugador">
    ...
    <div class="pizarra-ficha">
        <form action="<?php echo e(route('estadisticas.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>

            <?php echo $__env->make('admin.estadisticas.partials.form', ['estadistica' => null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sergio/proyecto2DAW_SergioBonillo_PauVila/BellreguardBasket/resources/views/admin/estadisticas/create.blade.php ENDPATH**/ ?>