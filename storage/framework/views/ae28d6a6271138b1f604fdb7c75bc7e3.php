...
<section class="contenedor-estadisticas">
    <?php if($estadisticas->isNotEmpty() && $estadisticaSeleccionada): ?>
        <div class="selector-temporadas" style="display: flex; flex-wrap: wrap; gap: 10px;">
            <select id="equipo-select" data-current="<?php echo e($equipoSeleccionado); ?>" class="btn-temp equipo-select" aria-label="Seleccionar equipo">
                <?php $__currentLoopData = $equiposConEstadisticas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipoStat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($equipoStat->equipo_id); ?>" <?php echo e((int) $equipoStat->equipo_id === (int) $equipoSeleccionado ? 'selected' : ''); ?>>
                        <?php echo e($equipoStat->equipo?->nombre ?? 'Equipo'); ?> - <?php echo e($equipoStat->temporada ?? '2025/2026'); ?>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    equipoSelect.addEventListener('change', function () {
        ...
        const url = new URL('<?php echo e(route('basket.estadisticas')); ?>', window.location.origin);
