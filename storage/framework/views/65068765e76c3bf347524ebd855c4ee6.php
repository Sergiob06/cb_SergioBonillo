...
<div class="contenedor-edit-jugador">
    <header class="header-ficha">
        <div>
            ...
            <p>Actualizando la fila de <strong><?php echo e($clasificacion->equipo_nombre); ?></strong></p>
        </div>
        <a href="<?php echo e(route('clasificaciones.index')); ?>" class="btn-volver-link">
    ...
    <div class="pizarra-ficha">
        <form action="<?php echo e(route('clasificaciones.update', $clasificacion->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <?php echo $__env->make('admin.clasificaciones.partials.form', ['clasificacion' => $clasificacion], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sergio/proyecto2DAW_SergioBonillo_PauVila/BellreguardBasket/resources/views/admin/clasificaciones/edit.blade.php ENDPATH**/ ?>